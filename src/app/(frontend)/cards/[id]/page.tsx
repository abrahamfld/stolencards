        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gray-800/50 rounded-xl p-6 mb-6 border border-red-800/30">
            <div className="flex justify-between items-start mb-3">
              ...
              <span className="text-2xl font-bold text-red-400">${card.price.toFixed(2)}</span>
            </div>
          ...
          {!showPaymentDetails ? (
            ...
            <div className="space-y-4 mt-6">
              ...
              <div className={`p-4 rounded-md ${user.walletBalance < card.price ? 'bg-red-900/20 border border-red-600' : 'bg-gray-900'}`}>
                <p className="text-gray-300 mb-1">Your Wallet Balance: ${user.walletBalance.toFixed(2)}</p>
                {user.walletBalance < card.price && (
                  <p className="text-sm text-red-300">
                    You need ${(card.price - user.walletBalance).toFixed(2)} more to complete this purchase.
                  </p>
                )}
              </div>
