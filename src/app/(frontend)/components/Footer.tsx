    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 border-t border-gray-700 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-sm font-semibold text-gray-200 uppercase tracking-wider mb-4">Products</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={item.name}>
                  <Link href={item.href} className="text-gray-400 hover:text-amber-400 transition-colors text-sm">
                    {item.name}
                  </Link>
                </li>
              ))}
