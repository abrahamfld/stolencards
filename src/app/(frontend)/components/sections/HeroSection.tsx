        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0">
              These cards are extracted from compromised payment channels, From
              ATM and POS Machines .<br />
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 text-center text-xs text-red-400/70 max-w-sm mx-auto">
              * Digital assets are provided as-is. Users assume all
              responsibility. Not available in prohibited jurisdictions.
              Cryptocurrency only.
            </div>
          </div>
        </div>
