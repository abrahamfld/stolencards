    ...
    <section className="relative bg-black py-24 border-t border-red-800/30">
      <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-xl border border-red-800/30">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl font-bold text-red-400">
                Retail Terminal Extraction
              </h3>
            </div>
            <p className="text-gray-400 mb-4">
              Specialized collection devices temporarily interface with payment
              authorization systems during transaction verification phases.
            </p>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-xl border border-red-800/30">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl font-bold text-amber-400">
                Automated Collection Nodes
              </h3>
            </div>
            <p className="text-gray-400 mb-4">
              Modified transaction interfaces with secondary data capture
              capabilities, operating within standard service maintenance
              windows.
            </p>
        ...
        <div className="bg-gradient-to-br from-black to-gray-900 p-8 rounded-xl border border-red-800/30 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="mb-2 text-red-400 font-mono text-sm">
                RAW CAPTURE
              </div>
              <div className="h-1 bg-gradient-to-r from-red-600 to-transparent"></div>
            </div>
            <div className="text-center">
              <div className="mb-2 text-amber-400 font-mono text-sm">
                FILTERING
              </div>
              <div className="h-1 bg-gradient-to-r from-red-500 to-amber-500"></div>
            </div>
            <div className="text-center">
              <div className="mb-2 text-green-400 font-mono text-sm">
                VALIDATION
              </div>
        ...
        <div className="mt-12 text-center text-xs text-red-400/50 max-w-3xl mx-auto">
          * This educational overview demonstrates hypothetical data security
          vulnerabilities. All referenced techniques are presented for academic
          study of payment system security. Actual implementation violates
          numerous international laws. We do not condone or participate in any
          illegal activities.
        </div>
      </div>
