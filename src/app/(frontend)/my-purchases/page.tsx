  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const initialRevealedState = cardsData.docs.reduce((acc: Record<number, boolean>, card: PurchasedCard) => {
          acc[card.id] = false;
          return acc;
        }, {});
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {cards.length === 0 ? (
            <div className="bg-gray-800/50 rounded-xl p-8 text-center border border-gray-700">
              ...
              <h3 className="mt-4 text-xl font-medium text-gray-300">No cards purchased yet</h3>
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    <div>
                      ...
                      <p className="font-mono">{formatExpiry(card.expiry, revealedCards[card.id])}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-400">CVV</p>
                      <p className="font-mono">{formatCVV(card.cvv, revealedCards[card.id])}</p>
                    </div>
                    <div>
